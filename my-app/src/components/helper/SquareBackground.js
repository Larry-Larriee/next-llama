...
export default function SquareBackground() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-48 left-1/3 h-16 w-16 rounded-md bg-blue-500/25 backdrop-blur-2xl sm:hidden xl:bottom-32 xl:block 2xl:bottom-20" />
      <div className="absolute bottom-64 right-96 h-16 w-16 rounded-md bg-blue-500/25 backdrop-blur-2xl sm:hidden xl:bottom-32 xl:right-96 xl:block 2xl:bottom-20 3xl:left-1/2" />
